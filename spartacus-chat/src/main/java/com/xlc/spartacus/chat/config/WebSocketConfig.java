...
import com.xlc.spartacus.chat.intercepter.HttpHandShakeIntercepter;
import com.xlc.spartacus.chat.intercepter.SocketChannelIntercepter;
...
public class WebSocketConfig extends AbstractWebSocketMessageBrokerConfigurer{
	...
	@Resource
	private HttpHandShakeIntercepter httpHandShakeIntercepter;
	...
	public void registerStompEndpoints(StompEndpointRegistry registry) {
		...
		registry.addEndpoint("/endpoint").addInterceptors(httpHandShakeIntercepter)
