<div align=center><img src="imgs/spartacus.png"></div>
...
数据监控：支持流量总览、访问统计、封禁/解禁异常高频访问用户、实时查看服务器负载情况等功能，<a href="https://github.com/xlvchao/spartacus/blob/main/imgs/data_monitor.png" target="_blank">功能思维导图</a>

文章管理：支持写文章、缓存到本地/从本地加载、发表文章、存草稿箱等功能，<a href="https://github.com/xlvchao/spartacus/blob/main/imgs/article_manage.png" target="_blank">功能思维导图</a>

评论管理：支持评论审核、回复评论、禁止/解禁用户评论等功能，<a href="https://github.com/xlvchao/spartacus/blob/main/imgs/comment_manage.png" target="_blank">功能思维导图</a>

资源管理：支持照片/视频等资源的批量上传、资源重命名、设置资源访问权限等功能，<a href="https://github.com/xlvchao/spartacus/blob/main/imgs/resource_manage.png" target="_blank">功能思维导图</a>

系统设置：支持查看系统登录足迹，管理通知公告、友情链接、系统用户等功能，<a href="https://github.com/xlvchao/spartacus/blob/main/imgs/system_function.png" target="_blank">功能思维导图</a>

数据同步：支持全量/增量同步业务数据、实时聊天数据到Elasticsearch，<a href="https://github.com/xlvchao/spartacus/blob/main/imgs/data_syn.png" target="_blank">功能思维导图</a>

在线聊天：支持私聊、群聊、推送在线用户、上线时提示离线消息、保存联系人等功能，<a href="https://github.com/xlvchao/spartacus/blob/main/imgs/chat.png" target="_blank">功能思维导图</a>

**博客端**

顶部菜单：首页、技术、算法、架构、职场、生活、归档，单击任一选项展示对应分类的文章列表，<a href="https://github.com/xlvchao/spartacus/blob/main/imgs/top_menu.png" target="_blank">功能思维导图</a>

文章列表：点击顶部菜单选项或搜索文章时则会返回对应的文章列表，用户可对文章点赞/取消点赞等，<a href="https://github.com/xlvchao/spartacus/blob/main/imgs/article_list.png" target="_blank">功能思维导图</a>

左右边栏：左侧展示博主资料、通知公告列表，右侧展示阅读最多、点赞最多、最近评论等功能，<a href="https://github.com/xlvchao/spartacus/blob/main/imgs/![left_right_side](C:\Users\lvchao\Desktop\left_right_side.png" target="_blank">功能思维导图</a>

文章详情：用户点击文章列表页的文章超链接后进入文章详情，可对文章进行评论等功能，<a href="https://github.com/xlvchao/spartacus/blob/main/imgs/article_detail.png" target="_blank">功能思维导图</a>

搜索文章：基于Elasticsearch实现的文章搜索功能，支持分词处理、按照相似度返回文章列表，<a href="https://github.com/xlvchao/spartacus/blob/main/imgs/search_article.png" target="_blank">功能思维导图</a>

在线聊天：同管理端的在线聊天，支持私聊、群聊等功能，<a href="https://github.com/xlvchao/spartacus/blob/main/imgs/chat.png" target="_blank">功能思维导图</a>

社交登陆：提供QQ登陆、微信登陆两种社交登陆方式，用户登录后才能进行聊天、评论、点赞等功能，<a href="https://github.com/xlvchao/spartacus/blob/main/imgs/social_login.png" target="_blank">功能思维导图</a>
